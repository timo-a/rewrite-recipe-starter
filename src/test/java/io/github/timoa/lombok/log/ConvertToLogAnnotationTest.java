...
class ConvertToLogAnnotationTest implements RewriteTest {
    ...
    public void defaults(RecipeSpec spec) {
        spec.recipe(new ConvertSlf4j(null))
    ...
    void shouldNotReplaceWhenFieldNameDiffersFromSpecifiedName() {
        rewriteRun(
          spec -> spec.recipe(new ConvertSlf4j("log"))
            .parser(JavaParser.fromJavaVersion()
              .classpath("slf4j-api")),
    ...
    void replaceLog4j() {
        rewriteRun(
          spec -> spec.recipe(new ConvertLog4j2("log"))
            .parser(JavaParser.fromJavaVersion()
    ...
    void replaceLog() {
        rewriteRun(
          spec -> spec.recipe(new ConvertUtilLog("log"))
            .parser(JavaParser.fromJavaVersion()
              .logCompilationWarningsAndErrors(true)),
    ...
    void replaceJbossLog() {
        rewriteRun(
          spec -> spec.recipe(new ConvertJBoss("log"))
            .parser(JavaParser.fromJavaVersion()
              .logCompilationWarningsAndErrors(true)
    ...
    void replaceCommonsLog() {
        rewriteRun(
          spec -> spec.recipe(new ConvertCommons("log"))
            .parser(JavaParser.fromJavaVersion()
              .logCompilationWarningsAndErrors(true)
