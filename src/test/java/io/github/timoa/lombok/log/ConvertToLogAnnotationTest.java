...
class ConvertToLogAnnotationTest implements RewriteTest {
    ...
    public void defaults(RecipeSpec spec) {
        spec.recipe(new ConvertToSlf4jLogAnnotation(null))
    ...
    void shouldNotReplaceWhenFieldNameDiffersFromSpecifiedName() {
        rewriteRun(
          spec -> spec.recipe(new ConvertToSlf4jLogAnnotation("log"))
            .parser(JavaParser.fromJavaVersion()
              .classpath("slf4j-api")),
    ...
    void replaceLog4j() {
        rewriteRun(
          spec -> spec.recipe(new ConvertToLog4j2Annotation("log"))
            .parser(JavaParser.fromJavaVersion()
    ...
    void replaceLog() {
        rewriteRun(
          spec -> spec.recipe(new ConvertToUtilLogAnnotation("log"))
            .parser(JavaParser.fromJavaVersion()
              .logCompilationWarningsAndErrors(true)),
    ...
    void replaceJbossLog() {
        rewriteRun(
          spec -> spec.recipe(new ConvertToJBossAnnotation("log"))
            .parser(JavaParser.fromJavaVersion()
              .logCompilationWarningsAndErrors(true)
    ...
    void replaceCommonsLog() {
        rewriteRun(
          spec -> spec.recipe(new ConvertToCommonsAnnotation("log"))
            .parser(JavaParser.fromJavaVersion()
              .logCompilationWarningsAndErrors(true)
